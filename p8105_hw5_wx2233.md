...
rejected is not equal the true value of beta1. Becuase the null
hypothesis is that beta1 = 0 and when we rejecting H0, the model will
change. So we cannot gain the approximate result.
