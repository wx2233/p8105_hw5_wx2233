...
The sample average of estimate beta1 across tests for which the null is rejected is not equal the true value of beta1. Becuase the null hypothesis is that beta1 = 0 and when we rejecting H0, the model will change. So we cannot gain the approximate result.
